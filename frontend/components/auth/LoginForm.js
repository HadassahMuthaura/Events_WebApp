      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href={`/auth/register${router.query.redirect ? `?redirect=${encodeURIComponent(router.query.redirect)}` : ''}`} className="font-semibold text-primary-600 hover:text-primary-500 transition-colors">
              Create account
            </Link>
          </p>
        </div>
