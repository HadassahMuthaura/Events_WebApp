...
export default function DashboardContent() {
  ...
  return (
    <div className="flex-1 min-w-0 w-full min-h-screen bg-gray-50">
      {/* Top Header */}
      <div className="bg-white border-b border-gray-200 px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <h1 className="text-2xl font-bold text-gray-800 min-w-0">Overview</h1>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end w-full lg:w-auto min-w-0">
            <div className="relative flex-1 min-w-0 max-w-full">
              <input
                ...
                className="w-full min-w-0 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <FiSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={18} />
            </div>
            <button className="w-full sm:w-auto px-6 py-2 bg-indigo-900 text-white rounded-lg font-medium hover:bg-indigo-800 transition">
              Search
            </button>
            <div className="flex items-center space-x-3 ml-0 sm:ml-4 min-w-0">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-400 to-purple-500 flex items-center justify-center text-white font-bold shadow-md flex-shrink-0">
      ...
      {/* Main Content */}
      <div className="px-4 py-8 space-y-6 max-w-full mx-auto">
        {stats.loading ? (
          /* Loading State */
