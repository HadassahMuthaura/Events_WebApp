            ...
            <div className="card p-6 bg-blue-50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">{roleStats.total}</p>
                </div>
            ...
            <div className="card p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{roleStats.clients}</p>
                </div>
            ...
            <div className="card p-6 bg-blue-50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">{roleStats.organizers}</p>
                </div>
                <FiUserCheck className="text-blue-600" size={32} />
              </div>
            </div>
            ...
            <div className="card p-6 bg-green-50">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600">{roleStats.support}</p>
                </div>
